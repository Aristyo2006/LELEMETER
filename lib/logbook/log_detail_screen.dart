...
class _LogDetailScreenState extends State<LogDetailScreen> {
                ...
                child: ListView(
                  ...
                  children: [
                          ...
                          Positioned(
                            ...
                            child: Transform.rotate(
                              ...
                              child: Container(
                                ...
                                height: 15,
                                decoration: BoxDecoration(
                                  color: const Color(0xFFD2C8B4).withValues(alpha: 0.3),
                                  boxShadow: [
                                    BoxShadow(
                                      color: Colors.black.withValues(alpha: 0.02),
                                      blurRadius: 1,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _exifParamRow(Icons.camera_outlined, 'Aperture', 'f/${_entry.aperture.toStringAsFixed(1)}', isDark),
                          const SizedBox(height: 6),
                          _exifParamRow(Icons.shutter_speed_outlined, 'Shutter Speed', _fmtShutter(_entry.shutterSpeed), isDark),
                          const SizedBox(height: 6),
                          _exifParamRow(Icons.speed, 'ISO', '${_entry.iso}', isDark),
                          const SizedBox(height: 6),
                          _exifParamRow(Icons.wb_sunny_outlined, 'EV (Exposure Value)', _entry.ev.toStringAsFixed(1), isDark),
                          const SizedBox(height: 6),
                          _exifParamRow(Icons.exposure_outlined, 'Exposure Comp.', '${_entry.exposureCompensation >= 0 ? "+" : ""}${_entry.exposureCompensation.toStringAsFixed(1)} EV', isDark),
                          if (_entry.filmName != null) ...[
                            const SizedBox(height: 6),
                            _exifParamRow(Icons.movie_filter_outlined, 'Film Simulator', _entry.filmName!, isDark),
                          ],
                          if (_entry.roll != null && _entry.roll!.trim().isNotEmpty) ...[
                            const SizedBox(height: 6),
                            _exifParamRow(Icons.camera_roll_outlined, 'Film Roll', _entry.roll!.toUpperCase(), isDark),
                          ],
                          const SizedBox(height: 6),
                          _exifParamRow(Icons.calendar_today_outlined, 'Captured At', _fullDate(_entry.createdAt), isDark),
                          if (_entry.placeName != null) ...[
                            const SizedBox(height: 6),
                            _exifParamRow(Icons.place_outlined, 'Location', _entry.placeName!, isDark),
                          ],
                    ...
                    if (_editing) ...[
                      Text(
                        'Edit Title',
                        style: stampStyle(color: LogbookTheme.faded(isDark), size: 14),
                      ),
                      ...
                      Container(
                        ...
                        child: CustomPaint(
                          painter: LinedPaperPainter(
                            lineColor: LogbookTheme.faded(isDark).withValues(alpha: 0.25),
                            lineHeight: 23.0,
                            offsetTop: 20.0,
                          ),
                          child: TextField(
                      ...
                      Container(
                        ...
                        child: CustomPaint(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              _entry.note.trim().isEmpty ? 'No notes for this frame.' : _entry.note.trim(),
                              style: caveat(
                                size: 20,
                        ...
                        children: [
                          Expanded(
                            child: FilledButton.icon(
                              ...
                              label: Text(
                                'Save',
                                style: caveat(size: 22, weight: FontWeight.bold),
                              ),
  ...
  Widget _actionTile(
    ...
    final color =
        danger ? const Color(0xFFD46A6A) : LogbookTheme.ink(isDark);
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              label,
              style: caveat(size: 18, color: color),
            ),
          ],
        ),
      ),
